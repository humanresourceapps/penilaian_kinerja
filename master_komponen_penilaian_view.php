                ...
                <div id="page-content">
                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1>  <strong>Master Komponen Penilaian</strong><br>
                                    <small>Menu ini berisi data master komponen penilaian</small></h1>
                                </div>
                                <!-- END Main Title -->
                   ...
                   <div class="block full">
					<div class="block-title">
						<h2><strong>Table komponen penilaian</strong></h2>
					</div>

                    <a href="master_komponen_penilaian_add.php" class="btn btn-primary"> Tambah Data</a>
                        <br>
                        &nbsp;
						...
						<table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
							<thead>
								<tr>
                                      ...
                                      <th>nama komp penilaian</th>
                                       <th class="text-center">kode A</th>
                                        <th class="text-center">kode B</th>
							...
							<tbody>
								<?php
								include "config.php";
								$sql = "select * from tab_komponen_penilaian";
								...
								?>
									...
									<tr>
										...
										<td><?php echo $row['nama_komp_penilaian']; ?></td>
                                        <td><?php echo $row['nama_komp_penilaian']; ?></td>
                                        <td><?php echo $row['nama_komp_penilaian']; ?></td>
