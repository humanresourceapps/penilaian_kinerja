                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1>  <strong>Ubah Data Pegawai</strong><br>
                                    <small>Menu ini berfungsi untuk mengubah data pegawai</small></h1>
                                </div>
                                <!-- END Main Title -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><strong>Form Ubah Pegawai</strong></h2>
                                </div>
                                ...
                                <form action="master_pegawai_proedit.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                     <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Nama</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="nama" class="form-control" placeholder="Nama" value="<?php echo $data['nama']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                              <input type="text" id="example-datepicker2" name="tanggal_masuk" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $data['tanggal_masuk']; ?>" placeholder="yyyy-mm-dd">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo $data['tempat_lahir']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                           <input type="text" id="example-datepicker3" name="tanggal_lahir" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $data['tanggal_lahir']; ?>" placeholder="yyyy-mm-dd">
                                        ...
                                        <div class="col-md-9">
                                            <div class="radio">
                                                <label for="example-radio1">
                                                    <input type="radio" id="example-radio1"  name="gender" value="L" <?php if($data['gender'] == 'L'){ echo "checked=checked"; }?> > Laki - Laki
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label for="example-radio2">
                                                    <input type="radio" id="example-radio2"  name="gender" value="P" <?php if($data['gender'] == 'P'){ echo "checked=checked"; }?> > Perempuan
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea id="example-textarea-input" name="alamat" rows="9" class="form-control" placeholder="Alamat"> <?php echo $data['alamat']; ?> </textarea>
                                        </div>
                                    </div>
                                           ...
                                           <select id="example-select" name="jabatan" class="form-control" size="1">
                                                <option value="" selected="selected">--Pilih--</option>
                                                  <?php
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $row['id'];?>" <?php  if($data['id_jabatan'] == $row['id']) { echo "selected=selected";} ?> > <?php echo $row['nama_jabatan'];?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="email" class="form-control" value="<?php echo $data['email']; ?>"  placeholder="Email">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="no_telp" class="form-control" value="<?php echo $data['no_telp']; ?>" placeholder="No.Telp">
