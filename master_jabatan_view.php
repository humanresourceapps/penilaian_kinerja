                ...
                <div id="page-content">
                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1>  <strong>Master Jabatan</strong><br>
                                    <small>Menu ini berisi data master jabatan</small></h1>
                                </div>
                                <!-- END Main Title -->
                   ...
                   <div class="block full">
					<div class="block-title">
						<h2><strong>Table jabatan</strong></h2>
					</div>

                    <a href="master_jabatan_add.php" class="btn btn-primary"> Tambah Data</a>
                        <br>
                        &nbsp;
