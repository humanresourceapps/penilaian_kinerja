                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1><strong>Tambah Data kinerja</strong><br>
                                    <small>Menu ini berfungsi untuk menambah data kinerja</small></h1>
                                </div>
                                <!-- END Main Title -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><strong>Form Tambah kinerja</strong></h2>
                                </div>
                                <!-- END Form Elements Title -->

                                <!-- Basic Form Elements Content -->
                                <form action="master_kinerja_proadd.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            
                                   <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Name Pegawai</label>
                                        <div class="col-md-9">
                                      ...
                                      <div class="form-group">
                                             <label class="col-md-3 control-label" for="example-text-input">Periode Penilaian From</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-datepicker2" name="periode_penilaian_from" class="form-control input-datepicker" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                       

                                        <div class="form-group">
                                             <label class="col-md-3 control-label" for="example-text-input">Periode Penilaian to</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-datepicker2" name="periode_penilaian_to" class="form-control input-datepicker" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                       
                                        <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Target</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="target" class="form-control" placeholder="Target">
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Realisasi</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="realisasi" class="form-control" placeholder="Realisasi">
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Keterangan</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="keterangan" class="form-control" placeholder="keterangan">
