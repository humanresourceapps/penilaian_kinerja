                ...
                <div id="page-content">
                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1>  <strong>Master kinerja</strong><br>
                                    <small>Menu ini berisi data master kinerja</small></h1>
                                </div>
                                <!-- END Main Title -->
                   ...
                   <div class="block full">
					<div class="block-title">
						<h2><strong>Table kinerja</strong></h2>
					</div>

                      <a href="master_kinerja_add.php" class="btn btn-primary"> Tambah Data</a>
                        <br>
                        &nbsp;
					...
					<div class="table-responsive">
						<table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
							<thead>
								...
								<tr>
									 <th class="text-center">No</th>
                                        <th>Id Pegawai</th>
                                        <th>Periode Penilaian from</th>
                                        <th>Periode Penilaian To</th>
                                         <th>Target</th>
                                         <th>Realisasi</th>
                                         <th>Keterangan</th>
							...
							<tbody>
                                <?php
                                include "config.php";
                                $sql = "select a.*,b.nama from tab_kinerja a
                                ...
                                ?>
					               <tr>
										...
										<td><?php echo $row['periode_penilaian_from']; ?></td>
										<td><?php echo $row['periode_penilaian_to']; ?></td>
