                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1><strong>Tambah Data Jabatan</strong><br>
                                    <small>Menu ini berfungsi untuk menambah data jabatan</small></h1>
                                </div>
                                <!-- END Main Title -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><strong>Form Tambah Jabatan</strong></h2>
                                </div>
                                <!-- END Form Elements Title -->

                                <!-- Basic Form Elements Content -->
                                <form action="master_jabatan_proadd.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            
                                   <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Name Jabatan</label>
                                        <div class="col-md-9">
