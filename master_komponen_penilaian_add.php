                        ...
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    <h1><strong>Tambah Data Komponen Penilaian</strong><br>
                                    <small>Menu ini berfungsi untuk menambah data komponen penilaian</small></h1>
                                </div>
                                <!-- END Main Title -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><strong>Form Tambah komponen penilaian</strong></h2>
                                </div>
                                <!-- END Form Elements Title -->

                                <!-- Basic Form Elements Content -->
                                <form action="master_komponen_penilaian_proadd.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            
                                   <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Name aspek penilaian</label>
                                        <div class="col-md-9">
                                         <input type="text" id="example-text-input" name="nama_aspek_penilaian" class="form-control" placeholder="nama_aspek_penilaian">
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">user insert</label>
                                        <div class="col-md-9">
                                           <select id="example-select" name="level" class="form-control" size="1">
                                                <option value="" selected="selected">--Pilih--</option>
                                                <option value="1">Abdul gopar</option>
                                                <option value="2">Aan</option>
                                        ...
                                        <div class="form-group">
                                             <label class="col-md-3 control-label" for="example-text-input">date insert</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-datepicker2" name="date_insert" class="form-control input-datepicker" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
